(function () {
  ...
  var searchIndex = [
    ...
    { page: 'People', url: 'people.html', title: 'Katia Chadaideh', text: 'Former Graduate Student. Assistant Director of Student Services, Harvard Griffin Graduate School of Arts & Sciences.' },
    { page: 'People', url: 'people.html', title: 'Eric Chan', text: 'Former Undergraduate Researcher.' },
    { page: 'People', url: 'people.html', title: 'Molly Chiang', text: 'Former Undergraduate Researcher and Hoopes Prize Awardee. M.D. candidate, Harvard Medical School.' },
    { page: 'People', url: 'people.html', title: 'Jessica Diaz', text: 'Former Undergraduate Researcher and Herchel Smith Fellow. Ph.D. candidate in Biological Sciences, University of Pittsburgh.' },
    { page: 'People', url: 'people.html', title: 'Caroline Diggins', text: 'Former Undergraduate Researcher and Hoopes Prize Awardee. M.D. candidate, Harvard Medical School.' },
    { page: 'People', url: 'people.html', title: 'Kevin Eappen', text: 'Former Undergraduate Researcher. M.D. candidate, Warren Alpert Medical School, Brown University.' },
    { page: 'People', url: 'people.html', title: 'Mira-Rose Kingsbury Lee', text: 'Former Undergraduate Researcher, Herchel Smith Fellow, 2024 Rhodes Scholar. Ph.D. Program in Interdisciplinary Bioscience, Oxford University.' },
    { page: 'People', url: 'people.html', title: 'Andrew Li', text: 'Former Undergraduate Researcher. M.D. candidate, UMass Chan Medical School.' },
    ...
    // Publications
    { page: 'Publications', url: 'publications.html', title: 'Zzztest et al. (2026)', text: 'Zzz content-bot EDITED test paper. Test Journal. 2026.' },
